...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[url(/13.jpg)]">
        ...
        <div className="py-6 text-sm text-center dark:text-gray-400">©All rights reserved by <span className='text-emerald-400 font-bold'>Sahariar Alam</span> </div>
    </footer>
    );
};
